  ...
  return (
    <article className="pt-36 pb-24">
      <div className="max-w-3xl mx-auto px-6 md:px-10">
        ...
        <span className="field-code uppercase mt-8 block">{item.code}</span>
        ...
        {item.status && (
          <span className="inline-block mt-4 text-xs font-medium text-mist bg-clay px-3 py-1.5 rounded-full">
            {item.status}
          </span>
        )}
        ...
        <div className="mt-10 prose-like space-y-5 text-ink-soft leading-relaxed">
